...
namespace abaBackOffice.Infrastructure
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private readonly ILogger<AbllsVideoRepository> _abllsVideoLogger;
        ...
        private IAbllsVideoRepository _abllsVideoRepository;
        ...
        public UnitOfWork(
            ...
            ILogger<AbllsVideoRepository> abllsVideoLogger,
        ...
        )
        {
            ...
            _abllsVideoLogger = abllsVideoLogger;
        ...
        public IAbllsVideoRepository AbllsVideoRepository => _abllsVideoRepository ??= new AbllsVideoRepository(_context, _abllsVideoLogger);
